    ...
    <div class="main-content-wrap sidenav-open d-flex flex-column">
        <div class="main-content">
            ...
            <div class="card card-info">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form class="form-horizontal" action="{{ route('admin.sliders.update',['slider'=>$slider->id]) }}" method="post">
                    @csrf
                    @method('patch')
                    <div class="card-body row">
                        ...
                        <div class="form-group col-4">
                            ...
                            <div class="input-group">
                                <input value="{{ $slider->image }}" type="text" id="image_label" class="form-control" name="image">
                        ...
                        <div class="form-group col-3">
                            ...
                            <input value="{{ $slider->alt }}" name="alt" type="text" class="form-control" id="inputEmail3" placeholder="متن جایگزین را وارد کنید">
                        </div>

                        <div class="form-group col-3">
                            <label for="inputEmail3" class="col-sm-10 control-label">لینک ارجاع</label>
                            <input value="{{ $slider->url }}" name="url" type="text" class="form-control" id="inputEmail3" placeholder="لینک ارجاع را وارد کنید">
                        </div>
