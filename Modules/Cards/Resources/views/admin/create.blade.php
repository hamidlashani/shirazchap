    ...
    <div class="main-content-wrap sidenav-open d-flex flex-column">
        <div class="main-content">
            ...
            <div class="card card-info">
                ...
                <form class="form-horizontal" action="{{ route('admin.cards.store') }}" method="post">
                    @csrf
                    <div class="card-body ">
                        <div class="row">
                            <div class="col-6">
                                            ...
                                            <div class="addfiles addfile1">
                                                <div class="row mb-2">
                                                    ...
                                                    <div class="col-3">
                                                        ...
                                                        <span onclick="delfile(1)" class="btn btn-danger w-100">حذف</span>
                                                    </div>
                                                </div>
