                        ...
                        <div class="form-group col-12">
                            ...
                            <div class="form-group col-12">
                                ...
                                <select required name="imagespath" class="form-control imagespath">
                                    @if($banner->imagespath)
                                        <option value="{{ $banner->imagespath }}">{{ $banner->imagespath }}</option>
                                    @endif
                                    <?php
                                ...
                                <div class="modal-dialog modal-lg">
                                    ...
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <h4 class="modal-title" style="text-align: center;width: 100%">مدیریت تصاویر {{ $banner->name }}</h4>
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <script>
                                                    $("#input-700").fileinput({
                                                        uploadUrl: "{{ route('admin.uploads','path='.$banner->imagespath) }}",
                                                        maxFileCount: 5,
                                                        theme: 'fa',
                                                        language: 'fa',
                                                    });
                                            ...
                                            <?php
                                            if($banner->imagespath){
                                            $images = array_diff(scandir($banner->imagespath), array('..', '.','thumb'));

                                            foreach ($images as $image){ ?>


                                               <div class="Portfolio"><a href="#!"><img class="card-img" src="{{ URL::asset($banner->imagespath.'/'.$image) }}" alt=""></a><div class="desc">{{ $image }}</div></div>
                                          <?php }
                                            }
                                            ?>
