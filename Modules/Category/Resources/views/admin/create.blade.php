                ...
                <form class="form-horizontal" action="{{ route('admin.category.store') }}" method="post">
                    ...
                    <div class="card-body row">
                        ...
                        <div class="form-group col-12">
                            ...
                            <input value="" name="title" type="text" class="form-control" id="inputEmail3" placeholder="عنوان را وارد کنید">
                        </div>
                                ...
                                <select required name="type" class="form-control category">
                                    ...
                                    @foreach($modules as $module)
                                        ...
                                        <?php    $modulesdate = new \Nwidart\Modules\Json($module->getpath().'/module.json') ; ?>
                                            <option value="{{ $modulesdate->get('model') }}">{{ $module->getName() }}</option>
                                        @endif
                                    @endforeach
                                </select>
                            </div>
