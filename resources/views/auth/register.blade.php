                ...
                <div class="row">
                        ...
                        <div class="p-4">
                            ...
                            <form method="POST" action="{{ route('register') }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="name" class="form-control form-control-rounded " name="name" value="" required="" autocomplete="name" autofocus="">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" id="password_confirmation" class="form-control form-control-rounded " name="password_confirmation" required="" autocomplete="current-password">
                                </div>
                    ...
                    <div class="col-md-6 text-center " style="background-size: cover;background-image: url(img/photo-long-3.jpg">
                        <div class="pr-3 auth-right">
                            ...
                            <a class="btn btn-rounded btn-outline-primary btn-outline-email btn-block btn-icon-text" href="{{ route('login') }}">
