                ...
                @foreach($cards as $card)
                    ...
                    <div class="col-sm-12 col-md-4 col-lg-4 mb-2">
                        <div class="card hovercard">
                            <div class="cardheader" style="background-size: cover !important;background: url(/{{ $card->image }})">
                            ...
                            <div class="bottom">
                                @if($card->name)
                                <a style="width: 100%" class="btn btn-primary btn-twitter btn-lg" href="{{ route('card',$card->slug) }}">
                                    مشاهده
                                </a>
                                    @else
                                    <a style="width: 100%" class="btn btn-primary btn-twitter btn-lg" href="{{ route('cards',$card->slug) }}">
                                        مشاهده
                                    </a>
